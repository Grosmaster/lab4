...
import com.lab.springboost.SpringboostApplication;
...
public class SenderMessage {
    ...
    public static void send(String massage) {
        JmsTemplate jmsTemplate = SpringboostApplication.context.getBean(JmsTemplate.class);
    ...
    public static void generateAndSendEmail(String massage, String email) throws AddressException, MessagingException {
        ...
        generateMailMessage.setSubject("vlko lab 4 jms");
        String emailBody = massage;
        ...
        transport.connect("smtp.gmail.com", "vlkojms@gmail.com", "jmsqwert");
